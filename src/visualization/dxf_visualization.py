...
class DXFVisualization:
    ...
    def render_dxf(
        ...
        for entity in entities:
            ...
            self.renderer.render_entity(
                entity, self.ax, color=color, linewidth=linewidth, zorder=zorder
            )
    ...
    def _should_render_entity(self, entity):
        ...
        if hasattr(entity, "dxf") and hasattr(entity.dxf, "layer"):
            ...
            if (
                layer_name in self.layer_visibility
                and not self.layer_visibility[layer_name]
            ):
                return False
    ...
    def _get_entity_color(self, entity):
        ...
        if (
            hasattr(entity, "dxf")
            and hasattr(entity.dxf, "color")
            and entity.dxf.color != 256
        ):
            # 转换DXF颜色索引为RGB
            try:
