...
def main():
    ...
    parser.add_argument('--output', type=str, help='输出图像文件路径（可选）', default=None)
    parser.add_argument('--highlight', type=str, help='高亮显示的块名称（可选）', default=None)
    parser.add_argument('--show-blocks', action='store_true', help='是否显示块边界')
    parser.add_argument('--show-connections', action='store_true', help='是否显示连接关系')
